...
hi ModeMsg                 gui=underline   guifg=bg      guibg=#339598   

" popup Menu {{{1
hi Pmenu                     guifg=bg  guibg=#7990a4 gui=NONE 
hi PmenuSel                  guifg=#7990a4 guibg=bg gui=NONE 
...
" tabs
hi TabLineFill			   gui=underline   guifg=bg		 guibg=#051524
hi TabLine				   gui=underline   guifg=bg  	 guibg=#051524
" highlight selected directory in the nerd tree	
hi CursorLine			   gui=none		   guifg=bg		 guibg=#667888 
