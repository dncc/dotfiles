...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayU2\x01\xd9\xd0\xcb\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00)\x00\x00\t\xff\x00\x00\x05\x9f\x00\x00\x00\x01\x00\x00\x00)\x00\x00\t\xfe\x00\x00\x05\x9e\x00\x00\x00\x00\x00\x00\x00\x00\n\x00\x85\x87Rq\x03.')
...
viewer_search_history = cPickle.loads('\x80\x02]q\x01(X\x19\x00\x00\x00A Good Man Is Hard to Finq\x02X\n\x00\x00\x00Maupassantq\x03e.')
...
plugin_search_history = cPickle.loads('\x80\x02]q\x01X\x04\x00\x00\x00Fileq\x02a.')
